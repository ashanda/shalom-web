...
<head>
	...
	<style type="text/css">
		...
		.top-bg {
			background: <?php echo wp_kses( $color['border_top'], 'entities' ); ?>;
		}
		...
		form.newsletter .submit:after {
			border-right-color: <?php echo wp_kses( $newsletter['submit']['color'], 'entities' ); ?>;
		}

		form.newsletter .submit:hover:after {
			border-right-color: <?php echo wp_kses( $newsletter['submit']['hover'], 'entities' ); ?>;
		}
...
<div class="container">
	...
	<div class="yit-box">
		...
		<img src="<?php echo esc_url( $mascotte ); ?>" alt="Mascotte" class="mascotte" />
